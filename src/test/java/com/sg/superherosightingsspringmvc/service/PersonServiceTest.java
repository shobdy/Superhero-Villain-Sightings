...
public class PersonServiceTest {
    ...
    public void testRead() {
        ...
        Person readPerson = personService.read(createPerson1.getPersonId());
    ...
    public void testUpdate() {
        ...
        personService.update(createPerson1);
    ...
    public void testDelete() {
        ...
        personService.delete(createPerson1);
    ...
    public void testGetPersonsByLocation() {
        ...
        List<Person> personsByLocation = personService.getPersonsByLocation(l1);
        ...
        personsByLocation = personService.getPersonsByLocation(l1);
    ...
    public void testGetAllPersonsByOrganization() {
        ...
        List<Person> personsByOrgs = personService.getAllPersonsByOrganization(createOrg);
        ...
        personsByOrgs = personService.getAllPersonsByOrganization(createOrg);
