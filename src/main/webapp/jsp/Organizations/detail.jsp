...
<html>
    ...
    <body>
        <div class="container">
            ...
            <p>Description: <c:out value="${organization.organizationDescription}"/></p>
            ...
            <p>Contact Name: <c:out value="${organization.organizationContactName}"/></p>
            <p>Contact Phone: <c:out value="${organization.organizationContactPhone}"/></p>
            <p>Contact Email: <c:out value="${organization.organizationContactEmail}"/></p>
